        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    DateSince = table.Column<DateTime>(type: "TEXT", nullable: false),
                    DateUntil = table.Column<DateTime>(type: "TEXT", nullable: false),
                    NumberOfHours = table.Column<int>(type: "INTEGER", nullable: false),
                    IsPartialVacation = table.Column<int>(type: "INTEGER", nullable: false),
